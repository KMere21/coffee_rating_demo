...
\ * Pick a review from [CoffeeReview](https://www.coffeereview.com/review/). \
\ * Click into the review to see the *Blind Assessment* text. **Copy and paste it into the box below. \
\ Any reviews posted November 2022 or later will be new to the model**. You can see how well it does by comparing the prediction to the actual rating.")
